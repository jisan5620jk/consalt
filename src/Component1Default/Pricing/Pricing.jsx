      ...
      <div className='Container'>
        <div className='grid grid-cols-6 gap-10 lg:gap-0 lg:grid-cols-12'>
          ...
          <div className='col-span-6 lg:col-span-7 grid grid-cols-1 md:grid-cols-2 lg:items-start gap-7'>
            <div className='pricing-box group text-center bg-[url(/images/price-bg1.png)] bg-no-repeat bg-cover bg-top rounded-lg px-5 sm:px-8 lg:px-4 xl:px-8 pt-5 sm:pt-9 pb-6 sm:pb-10 relative z-10 before:absolute before:top-0 before:right-0 before:-z-10 before:w-full before:h-0 before:bg-[url(/images/pricing-hover.png)] before:bg-cover before:bg-no-repeat before:bg-top before:rounded-md before:transition-all before:duration-500 hover:before:h-full'>
            ...
            <div className='lg:-mt-10 pricing-box active group text-center bg-[url(/images/price-bg1.png)] bg-no-repeat bg-cover bg-top rounded-lg px-5 sm:px-8 lg:px-4 xl:px-8 pt-5 sm:pt-9 pb-6 sm:pb-10 relative z-10 before:absolute before:top-0 before:right-0 before:-z-10 before:w-full before:h-0 before:bg-[url(/images/pricing-hover.png)] before:bg-cover before:bg-no-repeat before:bg-top before:rounded-md before:transition-all before:duration-500 hover:before:h-full'>
              <div className='flex items-center gap-4'>
                <div className='pricing-icon size-[76px] bg-BodyBg-0 relative z-10 before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-white before:rounded-full before:scale-0 before:-z-10 before:transition-all before:duration-500 group-hover:before:scale-100 rounded-full flex justify-center items-center'>
                  <img
                    src={pricingIcon2}
