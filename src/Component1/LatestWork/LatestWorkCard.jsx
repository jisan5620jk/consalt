...
const LatestWorkCard = ({
  ...
  return (
    <div className="latest-work-box bg-PrimaryColor-0 relative z-10 overflow-hidden group rounded-xl transition-all duration-500 hover:p-5">
      ...
      <div className="latest-work-content pl-6 pt-[30px] pb-8 absolute -bottom-full left-0 group-hover:left-5 group-hover:bottom-5 z-10 rounded-se-lg bg-PrimaryColor-0 lg:w-9/12 xl:w-[300px] transition-all duration-500">
