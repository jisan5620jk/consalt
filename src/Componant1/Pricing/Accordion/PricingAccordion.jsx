  ...
  return (
    <div className="rounded-md overflow-hidden">
      <h2>
        ...
        >
          <span
            className={`text-white font-semibold font-FiraSans transition duration-400 group-hover:text-white text-base sm:text-lg md:text-2xl lg:text-base xl:text-2xl py-4 ${
      ...
      >
        <div className="overflow-hidden">
          <p className="pt-6 pb-11 text-sm sm:text-base !leading-[28px] font-FiraSans">
            {children}
          </p>
        </div>
      </div>
