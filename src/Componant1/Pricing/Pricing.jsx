      ...
      <div className="Container">
        <div className="grid grid-cols-1 gap-10 lg:gap-16 xl:gap-24 2xl:gap-[140px] lg:grid-cols-2 items-center">
          <div className="w-full mx-auto">
            ...
            <h1 className="font-FiraSans font-bold text-lg leading-7 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[28px] lg:leading-[38px] xl:text-[32px] xl:leading-[42px] 2xl:text-[37px] 2xl:leading-[47px] text-white mt-[18px] mb-12">
          ...
          <div>
            <div className="pricing-box active group bg-white rounded-md px-[30px] pt-9 pb-10 relative z-10  before:absolute before:top-0 before:right-0 before:-z-10 before:w-0 before:h-full before:bg-PrimaryColor-0 before:rounded-md before:transition-all before:duration-500 mb-[50px]">
              <h6 className="pricing-quality px-[22px] py-[5px] text-lg bg-PrimaryColor-0 rounded font-FiraSans text-white font-medium transition-all duration-500 absolute -top-[19px] right-7">
                Popular
              </h6>
              <div className="absolute top-6 sm:top-10 right-7 flex items-baseline gap-1">
                <CountUp
                  ...
                  prefix="$"
                  suffix="."
                  className="pricing-price text-[40px] font-FiraSans font-semibold text-HeadingColor-0 transition-all duration-500"
                />
                <h6 className="pricing-price font-FiraSans font-semibold text-lg transition-all duration-500">
                  99
                </h6>
              </div>
              <h6 className="pricing-limit font-FiraSans font-semibold text-lg transition-all duration-500 mb-3">
                FOR 1 YEARS
              </h6>
              <div className="flex gap-5">
                ...
                <div className="flex-1">
                  <h5 className="pricing-title font-FiraSans font-semibold mt-2 sm:mt-2 text-2xl sm:text-[28px] text-HeadingColor-0 transition-all duration-500 mb-1">
                    19 Days For Free
                  </h5>
                  <p className="pricing-desc font-FiraSans text-TextColor2-0 transition-all duration-500 mb-[26px]">
                  ...
                  <Link to={"/"}>
                    <button className="pricing-btn font-FiraSans font-medium text-lg text-HeadingColor-0 border border-PrimaryColor-0 rounded px-7 py-2 transition-all duration-500">
                      Purchaces
                    </button>
                  </Link>
                </div>
