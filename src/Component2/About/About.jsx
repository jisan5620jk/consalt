        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-[92px] lg:gap-10 2xl:gap-[92px] items-center">
          <div className="relative z-10">
            ...
            <div className="absolute top-0 right-0 sm:flex gap-5 items-center animate-dance3 hidden">
              ...
              <div>
                <h5 className="font-FiraSans font-semibold text-xl leading-8 text-HeadingColor-0">
                  Award Wining
                </h5>
                <h5 className="font-FiraSans font-semibold text-xl leading-8 text-HeadingColor-0 border-t border-HeadingColor-0">
                  Best Services
                </h5>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <p className="font-FiraSans text-TextColor2-0 pb-7">
            ...
            <div className="flex flex-col gap-y-7 2xl:flex-row 2xl:justify-between 2xl:items-center">
              ...
              <div className="bg-[#eff6fe] rounded-lg inline-block px-7 py-8 w-[300px]">
                <Link to={"/"} className="inline-block">
                  <button className="text-2xl font-FiraSans font-semibold text-HeadingColor-0 flex items-center gap-3">
