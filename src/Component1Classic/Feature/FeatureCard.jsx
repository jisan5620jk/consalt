...
const FeatureCard = ({
  ...
  return (
    <div className='group rounded-lg pt-8 px-6 lg:px-3 xl:px-6 bg-white transition-all duration-500 border border-transparent hover:border-PrimaryColor-0 relative z-10 pb-7'>
