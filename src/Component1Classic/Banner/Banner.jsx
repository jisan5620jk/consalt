...
const Banner = () => {
  return (
    <section className="bg-[url('/images/home2-banner.jpg')] bg-cover bg-center bg-no-repeat h-[600px] sm:h-[700px] md:h-[1240px] lg:h-[600px] xl:h-[548px] 2xl:h-[830px] flex items-center relative z-10 overflow-hidden">
        ...
        <div className='grid lg:grid-cols-2 items-center gap-16 lg:gap-0 mt-[72px]'>
          ...
          <div className='relative md:flex justify-end hidden'>
            <img
              src={bannerThumb}
              draggable='false'
              className='-mb-[125px] md:w-11/12 xl:w-[inherit] 2xl:max-w-[inherit] lg:-mb-24 xl:-mb-11 relative xl:left-[124px]'
            />
          </div>
        </div>
      </div>
