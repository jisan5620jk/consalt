    ...
    <div className="group p-5 transition-all duration-500 bg-white rounded-md">
      ...
      <div className="rounded-md relative z-20 flex justify-center bg-white transition-all duration-500 sm:px-3 lg:px-3 2xl:px-3 pt-7">
        <div>
          ...
          <Link to={blogUrl}>
            <button className="font-FiraSans text-left font-semibold text-lg sm:text-[22px] md:text-xl lg:text-base xl:text-xl 2xl:text-[23px] text-HeadingColor-0 transition-all duration-500 group-hover:text-PrimaryColor-0 mt-2 mb-5">
              {blogTitle}
            </button>
          </Link>
