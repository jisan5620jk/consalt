...
const Footer6 = () => {
  return (
    <footer className="bg-BodyBg4-0 relative z-10 overflow-hidden">
      <div className="py-9 mb-[88px] border-b border-Secondarycolor-0 border-opacity-15">
        <div className="Container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7 lg:gap-0 lg:grid-cols-3 lg:items-center">
            <div className="flex items-center gap-5">
              <div className="size-[60px] bg-PrimaryColor-0 rounded-full flex items-center justify-center text-white">
            ...
            <div className="flex lg:justify-center md:border-l lg:border-l-0 xl:border-x-2 border-Secondarycolor-0 border-opacity-15 py-2">
              <Link to={"/"}>
            ...
            <div className="flex lg:justify-end">
              <ul className="flex gap-3 items-center">
                <li>
                  <Link
                    to={"/"}
                    className="size-[48px] flex justify-center items-center rounded-full bg-BorderColor2-0 border-2 border-Secondarycolor-0 border-opacity-15 transition-all duration-500 text-PrimaryColor-0 hover:text-white relative z-10 after:absolute after:rounded-full after:top-0 after:left-0 after:bg-PrimaryColor-0 after:w-full after:h-full after:scale-0 after:-z-10 after:transition-all after:duration-500 hover:after:scale-100"
                  >
                    <ImFacebook2 size={"15"} />
                  </Link>
                </li>
      ...
      <div className="Container">
        <div className="grid gap-y-7 grid-cols-12">
          <div className="col-span-12 md:col-span-6 lg:col-span-4">
            <h4 className="font-FiraSans text-[22px] text-HeadingColor-0 font-medium mb-[33px]">
              About Us
            </h4>
            <p className="font-FiraSans text-[15px] text-TextColor2-0 opacity-80 mt-7 mb-6">
            ...
            <form action="#" method="post" className="relative w-10/12">
              <label htmlFor="email" className="relative">
                <input
                  ...
                  required
                  className="w-full h-[56px] outline-none font-FiraSans border-b border-Secondarycolor-0 border-opacity-15 bg-transparent py-4 text-white placeholder:text-white mb-4"
                />
              </label>
            ...
            <ul className="overflow-hidden">
              <li>
                <Link to={"/"} className="inline-block">
                  <button className="flex items-center justify-start gap-2 font-FiraSans -ml-5 hover:ml-0 text-[15px] text-TextColor2-0 transition-all duration-500 hover:text-PrimaryColor-0 hover:gap-1 mb-4">
        ...
        <div className="flex flex-col md:flex-row gap-y-7 md: md:col-span-6 justify-between md:items-center py-8 mt-[94px] border-t border-Secondarycolor-0 border-opacity-15">
          <div>
            <p className="font-FiraSans text-[15px] flex items-center text-HeadingColor-0">
          ...
          <div>
            <ul className="flex gap-3 sm:gap-6">
              <li>
                <button className="font-FiraSans text-[15px] flex items-center transition-all duration text-TextColor2-0 hover:text-PrimaryColor-0 uppercase">
                  Facebook
                </button>
              </li>
              <li>
